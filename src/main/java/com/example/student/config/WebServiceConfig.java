...
/**
 * 
 * http://localhost:8081/ws/alumnos.wsdl
 */
@EnableWs
@Configuration
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	public XsdSchema alumnosSchema() {
		return new SimpleXsdSchema(new ClassPathResource("xsd/alum.xsd"));
	}
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema alumnosSchema) {
		...
		wsdl11Definition.setTargetNamespace("http://school.com/gen");
